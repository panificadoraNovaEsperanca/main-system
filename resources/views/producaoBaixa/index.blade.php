            ...
            <div class="col-md-3 col-sm-12">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input autocomplete="off" value="{{ $_GET['data'] ?? '' }}" placeholder="Data de entrega"
                            type="text" class="form-control trigger float-right" name="data" id="data">
                    </div>
                                    ...
                                    <tbody style="background:#fafafa">
                                        ...
                                        @foreach ($producaos as $producao)
                                            <tr @if ($producao->deleted_at != null) style="background-color:#ff8e8e" @endif>
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($producao->dt_inicio)->format('d/m/Y H:i') }}
                                                </td>

                                                <td>
                                                    @if (!$producao->status)
                                                        <button data-id="{{ $producao->id }}" type="button"
                                                            class="btn btn-success confirmarProducao">OK<i
